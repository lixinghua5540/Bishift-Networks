...
# Useful when input is 4 dims.   #移除额外的维度 可能是[1,3,255,255] 变化为[3,255,255]
...
def diagnose_network(net, name='network'):
    mean = 0.0
    count = 0
    for param in net.parameters():   #网络的所有参数
        if param.grad is not None:   #是可训练的参数
