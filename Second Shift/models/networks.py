...
from models.modules.MyResUnet import MyUnetGenerator, MyShiftUnetGenerator, MyGenerator, MyTest
...
def define_G(input_nc, output_nc, ngf, which_model_netG, opt, mask_global, norm='batch', use_spectral_norm=False, init_type='normal', gpu_ids=[], init_gain=0.02):
    ...
    elif which_model_netG == 'MyTest':
        netG = MyTest(input_nc, output_nc)
    elif which_model_netG == 'MyUnet':
        netG = MyUnetGenerator(input_nc, output_nc)
    elif which_model_netG == 'MyShiftUnet':
        netG = MyShiftUnetGenerator(input_nc, output_nc)
