...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./datasets/exp/train', help='path to training/testing images')  #
        ...
        parser.add_argument('--niter', type=int, default=2000, help='# of iter at starting learning rate')
        ...
        parser.add_argument('--training_mask_folder', type=str, default='masks/testing_masks', help='prepared masks for training')
        self.isTrain = True
